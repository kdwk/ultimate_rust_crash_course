...
fn main() {
    ...
    for coord in arrow_coords {
        ...
        if coord.distance_from_center() > 5.0 {shots.push(Shot::Miss)}
        else if 5.0 >= coord.distance_from_center() && coord.distance_from_center() >= 1.0 {shots.push(Shot::Hit(coord.distance_from_center()))}
